...
class Jeu :
    ...
    def creerTexte(self) :
        self.texte = self._font.render(
            'Bienvenue sur Vacheline Invasion, je vais t expliquer comment se passe le jeux:'
            '-c est un jeux local en duo donc la coopération est de vigeur.'
            '-le but du jeux est d éliminer le plus de Vacheline sans se faire toucher par une d elle'
